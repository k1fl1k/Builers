...
public class DisplayComponents {
    public static void displayComponents(ComponentType type, List<Processor> processors, List<Motherboard> motherboards, List<GraphicCard> graphicsCards, List<PowerSupply> powerSupplies, List<SsdDrive> ssdDrives, List<SoundCard> soundCards) {
